...
# ╔═╡ 043cd13e-ac4c-11ec-0352-8d52fa62d8b2
begin
...
# ╔═╡ 690efb19-979d-4c4f-a547-c54499677b98
let
	μX = 68
	σX = sqrt(90)
	μY = 76
	σY = sqrt(110)
	ρ = -0.77
	Φ((88 - (μX + ρ*(σY/σX) * (64 - μX))) / σY) - Φ((74 - (μX + ρ*(σY/σX) * (64 - μX))) / σY)
end

# ╔═╡ 01a198c1-a184-45d8-a7a3-fca7a9ce3efd
(6 - 1)^2 / 12

# ╔═╡ 94e04f48-b7bf-4d24-871a-53d61fbbc131
let
	# Let X equal the outcome of the first roll
	# and Y equal the sum of the two rolls
	...
	X = countmap([x for (x,y) ∈ S])
	Y = countmap([y for (x,y) ∈ S])
...
# ╔═╡ aa1dd74b-1afa-4e95-8b49-3fb3fdfc745b
2 * (1//6) * (5//6)
...
manifest_format = "2.0"
project_hash = "5ae95c220f0b07a57d29a3f288878797e4e62a74"
